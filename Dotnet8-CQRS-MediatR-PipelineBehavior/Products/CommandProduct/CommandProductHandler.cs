...
using Dotnet8_CQRS_MediatR_PipelineBehavior.Exceptions;
using Dotnet8_CQRS_MediatR_PipelineBehavior.Models;
using FluentValidation;
using Marten;

namespace Dotnet8_CQRS_MediatR_PipelineBehavior.Products.CommandProduct
{
